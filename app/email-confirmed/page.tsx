          ...
          <CardHeader className="text-center space-y-6 pb-8 relative">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-600 text-lg">
                Your email has been successfully confirmed. Your account is now
                active!
              </p>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-8 px-8 pb-8">
            <div className="text-center space-y-4">
              <p className="text-gray-700 leading-relaxed">
                Welcome to Aitopia! You can now access all our AI-powered
                features including image generation, video creation, and more.
              </p>
            ...
            <div className="space-y-4">
              ...
              <Button
                asChild
                variant="outline"
                className="w-full border-purple-300 hover:bg-purple-50 text-purple-700 hover:text-purple-800"
              >
                <Link href="/">
